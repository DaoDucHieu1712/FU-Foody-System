          ...
          <div class="col-span-4 sm:col-span-3 sticky top-0 h-screen">
            <div class="bg-white shadow rounded-lg p-6">
              ...
              <div class="flex flex-col">
                ...
                <ul>
                  <li class="mb-2">Đã đăng 26 bài viết</li>
                  <li class="mb-2">Số lượng bình luận trong các bài viết gần đây: 100</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div class="bg-white shadow rounded-lg">
              <div className="md:col-span-2 py-4 px-6">
                ...
                <div className="text-justify py-2">
                  <div>
                    {" "}
                    Just wanna chill with you tonight🌗 And all the sorrow left
                    behind uh-oh🍉
                  </div>
                ...
                <div className=" py-2">
                  <div className="flex items-center justify-between">
                    <div className="flex flex-row-reverse items-center">
                      <span className="ml-2 text-gray-500">0 lượt thích</span>
                    </div>
