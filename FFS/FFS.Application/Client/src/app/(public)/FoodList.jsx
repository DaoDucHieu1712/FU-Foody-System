...
import UseWishlist from "./components/wishlist/WishlistDetails";
...
const FoodList = ({ foodId }) => {
    ...
    useEffect(() => {
        GetListAllFood();
    }, [foodNameFilter, foodFilter, minPrice, maxPrice, selectedCategory, pageNumber]);
            ...
            <div className="w-full">
                ...
                <div className="grid m-2 gap-1 grid-flow-row-dense grid-cols-2 grid-rows-3 lg:grid-cols-4">
                    {(foodList && foodList.length != 0) ?
                        (foodList.map((food) => (
                            <div key={food.id} className="px-1 pt-1 pb-2 border-solid border-2">
                                ...
                                <div>
                                    ...
                                    <Typography color="blue" className="pb-2 pointer-events-none">{food.price}.000đ</Typography>
                                </div>
                            </div>
                        )))
