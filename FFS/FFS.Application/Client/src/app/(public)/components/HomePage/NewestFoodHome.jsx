        ...
        <>
            ...
            {newFood ?
                newFood.map((newFoodItem) => (
                    <div key={newFoodItem.id} className="flex p-1 my-1 justify-between items-center border-r-2 border-solid border-blue-gray-100 shadow-lg">
