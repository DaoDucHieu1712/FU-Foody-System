import { Button, IconButton, Rating, Spinner, Textarea, Tooltip, Typography } from "@material-tailwind/react";
            ...
            <div className="grid grid-cols-[4fr,6fr] gap-12">
              ...
              <div className="content-food">
                ...
                <div className="food-name mx-1">
                  ...
                  <p className="text-base">Phân loại: {foodData.category.categoryName}</p>
                  ...
                  <p className="my-2 text-base font-bold flex items-center ">
                    ...
                    <span className="text-blue-500">{foodData.price}.000 VND</span>
                  </p>
                ...
                {foodList ?
                  (foodList.map((food, index) => (
                    <div key={index} className="px-1 pt-1 border-solid border-2">
                      <div className="group relative flex lg:flex-none">
                        ...
                        <div className="absolute hidden h-full w-full justify-around items-center group-hover:flex">
                          ...
                          <Tooltip content="Xem chi tiết món ăn">
                            <IconButton variant="text" className="bg-white rounded-full" onClick={() => navigate(`/food-details/${food.id}`)}>
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="30"
                                height="20"
                      ...
                      <div>
                        <Typography variant="h6" className="w-36 pointer-events-none">{food.foodName}</Typography>
                    ...
                    <Typography variant="h5" color="deep-orange" className="w-96">Không có món ăn nào cùng loại</Typography>
                  )}
              </div>
            </div>
            {/* END RECOMMENT FOOD */}
              ...
              <div className="py-2">
                <div className="flex justify-start gap-2">
                  ...
                  <div>
                    ...
                    <Typography variant="paragraph">Cho bố cái địa chỉ</Typography>
                    <div className="flex gap-2">
                      <Typography variant="small" className="cursor-pointer hover:text-orange-900"><i className="fal fa-heart pr-1"></i>Thích</Typography>
                      {openComment ?
                        (<Typography variant="small" className="cursor-pointer hover:text-orange-900" onClick={handleopenComent}><i className="fal fa-angle-double-up p-1"></i>Ẩn bình luận</Typography>)
                        :
                        (<Typography variant="small" className="cursor-pointer hover:text-orange-900" onClick={handleopenComent}><i className="fal fa-angle-double-down p-1"></i>Xem bình luận</Typography>)
                      }
                    </div>
                  </div>
                </div>
                  ...
                  (<div className="ml-10 border-[1px] p-3">
                    <div className="flex justify-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2">
                          <Typography variant="small" className="cursor-pointer hover:text-orange-900"><i className="fal fa-heart pr-1"></i>Thích</Typography>
                          <Typography variant="small" className="cursor-pointer hover:text-orange-900"><i className="fal fa-angle-double-right fa-rotate-90 p-1"></i>Xem bình luận</Typography>
                        </div>
                      </div>
                    </div>
