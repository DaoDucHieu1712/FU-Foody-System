        ...
        <div>
                ...
                <div className="grid grid-flow-row-dense grid-cols-4 lg:grid-rows-2 lg:grid-cols-5">
                    <div className="inline-flex px-1 pt-1 pb-2 border-solid border-2 col-span-4 lg:inline lg:row-span-2 lg:col-span-1">
                        ...
                        <div className="lg:py-2">
                            ...
                            <Typography color="blue">50.000đ</Typography>
            ...
            <div className="grid py-4 gap-4 grid-flow-row-dense grid-cols-2 justify-stretch lg:flex lg:gap-2">
                <div>
                    ...
                    <div className="flex px-1 py-1 justify-between items-center border-2 border-solid border-gray-500">
                        ...
                        <div>
                            <Typography variant="small" className="pointer-events-none">Chimico - Cơm Trộn & Kim Chi Tỏi Đen</Typography>
                            <Typography color="blue" className="pb-2 pointer-events-none">25.000đ</Typography>
                        </div>
                    </div>
                    <div className="flex px-1 py-1 justify-between items-center border-2 border-solid border-gray-500">
                ...
                {/* Best seller */}
                <div>
                    <Typography variant="h6">BÁN CHẠY NHẤT</Typography>
                    <div className="flex px-1 py-1 justify-between items-center border-2 border-solid border-gray-500">
                        <div className="pr-2 pointer-events-none">
                            <img
                                src="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2560&q=80"
                ...
                {/* Most review */}
                <div>
                    <Typography variant="h6">ĐÁNH GIÁ HÀNG ĐẦU</Typography>
                    <div className="flex px-1 py-1 justify-between items-center border-2 border-solid border-gray-500">
                        <div className="pr-2 pointer-events-none">
                            <img
                                src="https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2560&q=80"
