...
const DefaultLocation = ({ item, reload }) => {
  ...
  return (
    <>
      <p
        className="text-gray-400 text-center font-semibold border-solid border-2 border-gray-400 h-auto w-36 cursor-pointer hover:text-gray-600 hover:border-gray-600"
        onClick={handleOpen}
      >
        Đặt làm mặc định
      </p>
